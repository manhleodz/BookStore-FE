              ...
              <div className=' w-full relative'>
                <div className='flex w-full'>
                  <div className=' w-1/6'>
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" className=' active:scale-110 px-16'>
                  ...
                  <div className='flex items-center justify-center h-auto w-full' style={{ height: "500px" }} >
                    <div className='p-12 max-w-lg'>
                      <img alt='...' src={showImg !== detail.ImageProducts.image ? showImg : detail.Product.image} className='' />
                    </div>
                  </div>
                </div>
              </div>
