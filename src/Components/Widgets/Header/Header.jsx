            ...
            >
                <div className='bg-green-500 text-white text-lg flex flex-wrap items-center justify-around'>
                    ...
                    <div className='flex items-center space-x-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" fill='white' className=' cursor-pointer' onClick={() => { window.location.assign('https://www.facebook.com/profile.php?id=100045148546635') }}>
                            <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" fill='white' className=' cursor-pointer' onClick={() => { window.location.assign('https://www.instagram.com/hugsicula_/') }}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" fill='white' className=' cursor-pointer' onClick={() => { window.location.assign('https://twitter.com/') }}>
                ...
                >
                                                    ...
                                                    <div className='dropdown-icon' id="user-dropdown">
                                                        ...
                                                        >
                                                            <ul className="py-2 text-left" aria-labelledby="user-menu-button">
                                                                <li>
                                                                    <div onClick={() => navigate(`/profile/${user.id}/info`)} className="block cursor-pointer px-4 py-2 text-base text-gray-700 hover:bg-gray-100 ">{t('info')}</div>
                                                                </li>
                                                                <li>
                                                                    <div onClick={() => {
                                                                        dispatch(signOut())
                                                                    }}
                                                                        className="block cursor-pointer px-4 py-2 text-base text-gray-700 hover:bg-gray-100 ">{t('logout')}</div>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                    ...
                    <div className='max-w-screen-xl flex flex-col-reverse items-center justify-between max-md:h-screen max-md:fixed max-md:w-1/2'>
                        <div className={` duration-1000  transition items-center justify-between max-md:-translate-x-full ${click && 'max-md:translate-x-7/12'} max-md:w-1/2 max-md:bg-white max-md:z-20 max-md:fixed max-md:left-0 max-md:h-screen md:flex md:w-auto md:order-1`}id="navbar-user">
