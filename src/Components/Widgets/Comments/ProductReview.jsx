        ...
        <div className=' flex  max-2xl:flex-col  max-xl:items-center'>
          ...
          {user ? (
            ...
            <div className=' w-8/12 flex justify-center items-center text-center'>
              <h1>Chỉ có thành viên mới có thể viết nhận xét.Vui lòng <span onClick={() => { document.getElementById('modal').style.display = 'block' }} className='text-blue-500 underline cursor-pointer'>đăng nhập</span></h1>
            </div>
          )}
        </div>
